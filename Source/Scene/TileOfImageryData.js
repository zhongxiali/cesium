...
define([
     ...
     * @private
     */
    function TileOfImageryData(imageryLayer, x, y, level, rectangle) {
    ...
    TileOfImageryData.createPlaceholder = function(imageryLayer) {
    ...
    TileOfImageryData.prototype.addReference = function() {
        ++this.referenceCount;
    };

    TileOfImageryData.prototype.releaseReference = function() {
        --this.referenceCount;
    ...
    TileOfImageryData.prototype.processStateMachine = function(frameState, distance) {
